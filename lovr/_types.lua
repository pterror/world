...
if false then
	...
	--[[https://lovr.org/docs/Shader:hasVariable  ]]
	--[[Check if the Shader has a variable.  ]]
	--[[### See also]]
	--[[* [`Pass:send`](lua://lovr_pass.send)]]
	--[[* [`Shader`](lua://lovr_shader)]]
	--[[@param name string]]
	--[[@return boolean exists]]
	function Shader_class:hasVariable(name) return false end
	...
	--[[@operator mul (lovr_mat4): lovr_mat4]]
	--[[@operator mul (lovr_vec3): lovr_vec3]]
	--[[@operator mul (lovr_vec4): lovr_vec4]]
	...
	--[[@operator mul (lovr_quat): lovr_quat]]
	--[[@operator mul (lovr_vec3): lovr_vec3]]
	...
	--[[@operator add (lovr_vec2): lovr_vec2]]
	--[[@operator add (number): lovr_vec2]]
	--[[@operator div (lovr_vec2): lovr_vec2]]
	--[[@operator div (number): lovr_vec2]]
	--[[@operator mul (lovr_vec2): lovr_vec2]]
	--[[@operator mul (number): lovr_vec2]]
	--[[@operator sub (lovr_vec2): lovr_vec2]]
	--[[@operator sub (number): lovr_vec2]]
	...
	--[[@operator add (lovr_vec3): lovr_vec3]]
	--[[@operator add (number): lovr_vec3]]
	--[[@operator div (lovr_vec3): lovr_vec3]]
	--[[@operator div (number): lovr_vec3]]
	--[[@operator mul (lovr_vec3): lovr_vec3]]
	--[[@operator mul (number): lovr_vec3]]
	--[[@operator sub (lovr_vec3): lovr_vec3]]
	--[[@operator sub (number): lovr_vec3]]
	...
	--[[@operator add (lovr_vec4): lovr_vec4]]
	--[[@operator add (number): lovr_vec4]]
	--[[@operator div (lovr_vec4): lovr_vec4]]
	--[[@operator div (number): lovr_vec4]]
	--[[@operator mul (lovr_vec4): lovr_vec4]]
	--[[@operator mul (number): lovr_vec4]]
	--[[@operator sub (lovr_vec4): lovr_vec4]]
	--[[@operator sub (number): lovr_vec4]]
